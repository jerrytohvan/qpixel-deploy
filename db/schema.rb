...
ActiveRecord::Schema.define(version: 2021_07_12_144301) do
  ...
  create_table "abilities", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "ability_queues", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "post_flag_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.bigint "community_id"
    t.string "name"
    t.text "description"
  ...
  create_table "user_abilities", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.bigint "community_user_id"
    t.bigint "ability_id"
